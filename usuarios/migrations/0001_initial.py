    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data_nascimento', models.DateField(validators=[usuarios.models.validar_idade_usuario], verbose_name='Data de Nascimento')),
                ('cpf', models.CharField(max_length=14, unique=True, validators=[usuarios.models.validar_cpf], verbose_name='CPF')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nome_completo', models.CharField(max_length=200, verbose_name='Nome Completo')),
                ('data_nascimento', models.DateField(validators=[usuarios.models.validar_idade_dependente], verbose_name='Data de Nascimento')),
                ('cpf', models.CharField(max_length=14, unique=True, validators=[usuarios.models.validar_cpf], verbose_name='CPF')),
